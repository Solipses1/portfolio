...
export default function WorksPage() {
    return <div className="flex flex-1 justify-center items-center gap-x-8 xl:gap-x-24">
            <ProjectCard title="Muzario" link="https://play.google.com/store/apps/details?id=com.solipses.muzario" source="https://play.google.com/store/apps/details?id=com.solipses.muzario" image="/hometownhappenings.png" />
